...
class XMLHttpRequestInstrumentation extends instrumentation_1.InstrumentationBase {
    ...
    _addChildSpan(span, corsPreFlightRequest) {
        api.context.with(api.trace.setSpan(api.context.active(), span), () => {
            ...
            (0, sdk_trace_web_1.addSpanNetworkEvents)(childSpan, corsPreFlightRequest, this.getConfig().ignoreNetworkEvents, undefined, true);
    ...
    _findResourceAndAddNetworkEvents(xhrMem, span, spanUrl, startTime, endTime) {
        ...
        if (resource.mainRequest) {
            ...
            (0, sdk_trace_web_1.addSpanNetworkEvents)(span, mainRequest, this.getConfig().ignoreNetworkEvents, undefined, true);
        }
    }
    /**
    ...
    _createSpan(xhr, url, method) {
        ...
        if ((0, core_1.isUrlIgnored)(parsedUrl.href, this.getConfig().ignoreUrls)) {
